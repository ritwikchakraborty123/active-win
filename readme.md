...
```sh
npm install active-win-nhm
```

## Usage

```js
const activeWindow = require("active-win-nhm");
...
(async () => {
	...
	/*
	{
		...
		url: 'https://ritwikchakraborty123.com/unicorn',
...
If you use this package in an Electron app that is sandboxed and you want to get the `.url` property, you need to add the [proper entitlements and usage description](https://github.com/ritwikchakraborty123/active-win-nhm/issues/99#issuecomment-870874546).

## Users

- [active-win-nhm-log](https://github.com/uglow/active-win-nhm-log) - Window-usage logging CLI.
...
- [active-win-nhm-cli](https://github.com/ritwikchakraborty123/active-win-nhm-cli) - CLI for this module

## Maintainers

- [Sindre Sorhus](https://github.com/ritwikchakraborty123)
